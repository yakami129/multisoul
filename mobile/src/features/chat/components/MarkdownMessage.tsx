    ...
    >
      <Text
        style={{
          fontFamily: 'Inter',
          fontSize: 10,
          color: copied ? brandColors.ink : brandColors.textSoft,
          letterSpacing: 0.5,
        }}
      >
        {copied ? '✓ COPIED' : 'COPY'}
...
const mdStyles = {
  ...
  list_item: { color: brandColors.ink, fontFamily: 'Inter', fontSize: 15 },
  bullet_list_icon: { color: brandColors.textMuted },
  ordered_list_icon: { color: brandColors.textMuted },
  code_inline: {
    fontFamily: 'Inter',
    fontSize: 12,
    color: brandColors.ink,
  ...
  blockquote: {
    borderLeftWidth: 3,
    borderLeftColor: brandColors.cyan,
    paddingLeft: 10,
    marginVertical: 4,
  },
  blockquote_text: { color: brandColors.textSoft },
  hr: { backgroundColor: brandColors.silver, height: 1, marginVertical: 8 },
  strong: { color: brandColors.ink },
  em: { color: brandColors.textSoft },
  table: { marginVertical: 4 },
  thead: { backgroundColor: brandColors.silver },
  th: {
    fontFamily: 'Inter',
    fontSize: 12,
    fontWeight: '700' as const,
