  ...
  if (isLoading) {
    return (
      <View style={[s.root, { paddingTop: insets.top }]}>
        <View style={s.nav}>
          <TouchableOpacity onPress={onBack}><ArrowLeft size={20} color="#20C20E" /></TouchableOpacity>
        ...
        <View style={s.section}>
          ...
          <View style={s.row}>
            ...
            <View style={s.projectRow}>
              ...
              <Text style={s.rowValueMono} numberOfLines={2}>{agent.project_path}</Text>
            </View>
          </View>
          <View style={s.divider} />
          <View style={s.row}>
            <Text style={s.rowLabel}>ID</Text>
            <Text style={s.rowValueMono} numberOfLines={1}>{agent.id}</Text>
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  backBtn:      { borderWidth: 1, borderColor: '#20C20E', paddingHorizontal: 24, paddingVertical: 8, borderRadius: 2 },
  backBtnText:  { fontFamily: 'Inter', fontSize: 12, color: '#20C20E', letterSpacing: 1.5 },
  scroll:       { padding: 16, gap: 12 },
  headerCard:   { backgroundColor: '#061206', borderRadius: 2, borderWidth: 1,
                  borderColor: '#0F2B0F', padding: 16, flexDirection: 'row', alignItems: 'center', gap: 12 },
  avatar:       { width: 48, height: 48, borderRadius: 2, backgroundColor: '#0F2B0F',
                  alignItems: 'center', justifyContent: 'center' },
  avatarText:   { fontFamily: 'Anton', fontSize: 18, color: '#20C20E' },
  headerInfo:   { flex: 1, gap: 6 },
  agentName:    { fontFamily: 'Anton', fontSize: 18, color: '#20C20E' },
  runtimeBadge: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2,
                  borderRadius: 2, borderWidth: 1, borderColor: '#0F2B0F', backgroundColor: '#0A1A0A' },
  runtimeText:  { fontFamily: 'Inter', fontSize: 10, color: '#2D8B2D', letterSpacing: 0.8 },
  section:      { backgroundColor: '#061206', borderRadius: 2, borderWidth: 1,
                  borderColor: '#0F2B0F', padding: 16, gap: 12 },
  sectionTitle: { fontFamily: 'Anton', fontSize: 13, color: '#20C20E', letterSpacing: 1 },
  row:          { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 },
  rowLabel:     { fontFamily: 'Inter', fontSize: 11, color: '#2D8B2D', letterSpacing: 1.5, paddingTop: 2 },
  rowValue:     { fontFamily: 'Geist', fontSize: 13, color: '#20C20E', flex: 1, textAlign: 'right' },
  rowValueMono: { fontFamily: 'Geist Mono', fontSize: 11, color: '#147A16', flex: 1, textAlign: 'right' },
  projectRow:   { flex: 1, flexDirection: 'row', alignItems: 'flex-start', gap: 4, justifyContent: 'flex-end' },
  divider:      { height: 1, backgroundColor: '#0F2B0F' },
  messageInput: { backgroundColor: '#0A1A0A', borderRadius: 2, borderWidth: 1, borderColor: '#0F2B0F',
                  padding: 12, fontFamily: 'Geist', fontSize: 14, color: '#20C20E',
                  minHeight: 80, textAlignVertical: 'top' },
  invokeBtn:    { height: 44, backgroundColor: '#20C20E', borderRadius: 2,
                  alignItems: 'center', justifyContent: 'center' },
  invokeBtnDisabled: { opacity: 0.4 },
  invokeBtnText:{ fontFamily: 'Anton', fontSize: 14, color: '#040D04', letterSpacing: 1 },
  chatBtn:      { height: 44, borderRadius: 2, borderWidth: 1, borderColor: '#20C20E',
                  alignItems: 'center', justifyContent: 'center' },
